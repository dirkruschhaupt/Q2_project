  ...
  return knex('friends').del()
    .then(function () {
      ...
      return knex('friends').insert([
        ...
        {name: 'Krista Smith', address: '811 Bluebonnet', city: 'Edna', state: 'TX', phone: '5125551234', email: 'krista@gmail.com', birthday: 'November 4, 1980', sex: 'female', rank: 10, date: 'Feb 10, 2002', place: 'College', note: 'Bad ass person', photo: '../images/nophoto.png'},
        ...
        {name: 'Andy Baandi', address: '601 Third St', city: 'Austin', state: 'TX', phone: '5125551234', email: 'andy@gmail.com', birthday: 'November 17', sex: 'male', rank: 6, date: 'December 4, 2016', place: 'G.L.A.M. function', note: 'Austrian God', photo: 'https://goo.gl/images/txD6rT'},
        ...
        {name: 'Charles Parks', address: '505 Jasper', city: 'Austin', state: 'TX', phone: '5125551234', email: 'charles@gmail.com', birthday: 'November 16', sex: 'male', rank: 5, date: 'April 10, 2016', place: 'His house', note: 'Sounds like Foghorn Leghorn when he talks', photo: 'https://goo.gl/images/oRopFm'}
      ])
    })
    .then(function () {
      // Inserts seed entries
